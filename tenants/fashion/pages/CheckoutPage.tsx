      ...
      >
        ...
        >
          <div>
            <h1
              className={fashionFraunces.className}
              style={{ fontSize: 34, fontWeight: 600, letterSpacing: "0.2px" }}
            >
            ...
            <p
              ...
              style={{ color: FASHION_DARK_COLORS.boneDim }}
            >
              Four short steps — your fit is on hold for the next 15 minutes.
            </p>
            ...
            <div className="mt-8">
              ...
              >
                <div className="flex flex-col gap-3">
                  <label
                    className="flex flex-col gap-1.5 text-xs font-semibold uppercase"
                  ...
                  >
                    ...
                    <input
                      ...
                      className="h-11 rounded-lg px-3 text-sm font-normal normal-case outline-none"
                      style={inputStyle}
                    />
                  </label>
                  <button
                    ...
                    onClick={() => setStep(2)}
                    className="self-start rounded-xl px-6 py-3 text-sm font-semibold uppercase transition-colors hover:bg-[#CBA470] disabled:opacity-40"
                    style={primaryButtonStyle}
                  >
              ...
              >
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <label
                    className="col-span-2 flex flex-col gap-1.5 text-xs font-semibold uppercase"
                    style={fieldLabelStyle}
                  >
                    Address line 1
                    <input
                ...
                <button
                  ...
                  onClick={() => setStep(3)}
                  className="mt-4 self-start rounded-xl px-6 py-3 text-sm font-semibold uppercase transition-colors hover:bg-[#CBA470] disabled:opacity-40"
                  style={primaryButtonStyle}
                >
              ...
              >
                ...
                <button
                  type="button"
                  onClick={() => setStep(4)}
                  className="mt-4 self-start rounded-xl px-6 py-3 text-sm font-semibold uppercase transition-colors hover:bg-[#CBA470]"
                  style={primaryButtonStyle}
                >
                  Continue to Payment
                </button>
              ...
              >
                <div className="flex flex-col gap-4">
                      ...
                      >
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="h-11 w-full rounded-lg pl-9 pr-3 text-sm font-normal normal-case outline-none"
                            style={inputStyle}
                          />
                        </div>
                      </label>
                  ...
                  <button
                    ...
                    onClick={placeOrder}
                    className="mt-2 h-12 rounded-xl text-sm font-semibold uppercase transition-colors hover:bg-[#CBA470] disabled:opacity-40"
                    style={primaryButtonStyle}
                  >
                    Place Order
                  </button>
